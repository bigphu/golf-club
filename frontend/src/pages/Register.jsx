...
import InputSelect from '../components/InputSelect.jsx'; // Import the new Select component
...
const Register = () => {
  ...
  // This works for both InputForm and InputSelect because InputSelect mimics the event structure
    ...
    <>
      <div className='col-start-2 col-span-10 flex flex-col items-center justify-center min-h-[10vh] p-8 pb-0'>
        ...
        <div className='text-secondary-accent font-medium font-roboto mt-2'>
          Join the club to participate in tournaments
        </div>
      </div>
      ...
      <Tray pos='col-start-3' size='col-span-8' className='mt-4 mb-10'>
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full px-4 py-2">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <InputForm 
                label="VGA Number" 
                name="vgaNumber" 
                value={formData.vgaNumber} 
                onChange={handleChange} 
                placeholder="VGA-1234" 
                icon={Hash} 
              />
              
              {/* Using Custom InputSelect Component */}
              <InputSelect 
                label="Shirt Size"
                name="shirtSize"
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Bio Input (Textarea remains manual as InputForm is <input> only) */}
